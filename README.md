...
EAB WHDLoad Demos AGA Menu package contains menus for AGS2 and iGame with screenshots and details for all AGA demos currently available in English Board Amiga WHDLoad packs v3.0. Menus, screenshots and details are generated using powershell scripts and data files from https://github.com/henrikstengaard/amiga-whdload-game-scripts.
